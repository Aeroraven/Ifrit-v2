...
namespace Ifrit::Utility::Loader {
	...
	void WavefrontLoader::loadObject(const char* path, std::vector<ifloat3>& vertices,
		std::vector<ifloat3>& normals, std::vector<ifloat2>& uvs, std::vector<uint32_t>& indices) {
