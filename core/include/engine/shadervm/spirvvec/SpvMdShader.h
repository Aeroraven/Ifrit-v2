...
namespace Ifrit::Engine::ShaderVM::SpirvVec {
	...
	class SpvVecFragmentShader final : public FragmentShader, public SpvVecRuntimeBackend {
	public:
	...
	public:
		...
		IFRIT_HOST virtual void executeInQuad(const void** varyings,void** colorOutput,	float** fragmentDepth) override;
