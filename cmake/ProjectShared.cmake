...
set(IFRIT_PROJECT_SUBDIR "${IFRIT_PROJECT_DIR}/modules")
set(IFRIT_EXTERNAL_DEPENDENCY_PATH "${IFRIT_PROJECT_DIR}/dependencies")
set(IFRIT_COMPONENT_LLVM_SOURCE "${IFRIT_PROJECT_DIR}/modules/ircompile")
...
# set shared libraies
set(IFRIT_COMMON_DEPENDENCIES_SHARED spdlog)
...
include_directories(${IFRIT_PROJECT_DIR}/dependencies/cereal/include)
include_directories(${IFRIT_PROJECT_DIR}/dependencies/gcem/include)
include_directories(${IFRIT_PROJECT_DIR}/dependencies/spdlog/include)
