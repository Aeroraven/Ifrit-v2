...
#define REG_MESH_NEO(name, path, entry) REG_SHADER_NEO(name, path ".mesh.slang", RHI::RhiShaderStage::Mesh, entry)
        ...
        // REG_COMPUTE_NEO(ISTAya.GlobalDFRayMarchCS, "Ayanami/Ayanami.Debug.GlobalDFRayMarch",
        // "DebugGlobalDFRayMarchCS"); REG_COMPUTE(ISTAya.RayMarchCS, "Ayanami/Ayanami.RayMarch");
        ...
        // REG_FRAGMENT_NEO(ISTAya.SurfaceCacheGenFS, "Ayanami/Ayanami.SurfaceCache.Generate",
        // "SurfaceCacheGeneratePS"); REG_VERTEX_NEO(ISTAya.SurfaceCacheGenVS, "Ayanami/Ayanami.SurfaceCache.Generate",
        // "SurfaceCacheGenerateVS");
        ...
        // REG_FRAGMENT_NEO(ISTAya.DeferredShadowFS, "Ayanami/Ayanami.FinalLighting.DirectShadow",
        // "FinalDirectShadowPS"); REG_FRAGMENT_NEO(
