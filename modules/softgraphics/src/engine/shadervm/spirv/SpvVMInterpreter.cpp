...
namespace Ifrit::Graphics::SoftGraphics::ShaderVM::Spirv::Impl
{
...
#define DEPRECATED_OP(name)                                           \
    ...
    namespace InstructionImpl
    {
        ...
        DEFINE_OP(spvOpGroupDecorate){
            DEPRECATED_OP(OpGroupDecorate)
        } DEFINE_OP(spvOpGroupMemberDecorate){
            DEPRECATED_OP(OpGroupMemberDecorate)
        } DEFINE_OP(spvOpDecorationGroup){
            DEPRECATED_OP(OpDecorationGroup)
        }

        /* 3.52.4. Extension Instructions */
        DEFINE_OP(spvOpExtension){
            UNIMPLEMENTED_OP(OpExtension)
        ...
        DEFINE_OP(spvOpTypeEvent){
            UNIMPLEMENTED_OP(OpTypeEvent)
        } DEFINE_OP(spvOpTypeDeviceEvent){
            UNIMPLEMENTED_OP(OpTypeDeviceEvent)
        } DEFINE_OP(spvOpTypeReserveId){
            UNIMPLEMENTED_OP(OpTypeReserveId)
        } DEFINE_OP(spvOpTypeQueue){
            UNIMPLEMENTED_OP(OpTypeQueue)
        } DEFINE_OP(spvOpTypePipe){
        ...
        DEFINE_OP(spvOpConstantSampler){
            UNIMPLEMENTED_OP(OpConstantSampler)
        } DEFINE_OP(spvOpConstantNull){
        ...
        } DEFINE_OP(spvOpConvertUToF)
        {
            ...
            if (pass == IFSP_VMA_PASS_SECOND)
            {
                ...
                auto isSourceVector =
                    irContextGlobal->targets[source.resultTypeRef].declType == IFSP_IRTARGET_DECL_VECTOR;
                if (isSourceVector)
                {
                    ERROR_PREFIX;
...
#undef DEFINE_OP
  ...
  // Ifrit::Graphics::SoftGraphics::ShaderVM::Spirv::Impl
