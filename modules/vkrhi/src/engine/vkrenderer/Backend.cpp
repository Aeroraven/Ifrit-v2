...
#include "ifrit/vkrhi/engine/vkrenderer/RenderPass.h"
#include "ifrit/vkrhi/engine/vkrenderer/RenderTargets.h"
#include "ifrit/vkrhi/engine/vkrenderer/StagedMemoryResource.h"
#include "ifrit/vkrhi/engine/vkrenderer/Timer.h"

#include "ifrit/vkrhi/engine/fsr2extension/FSR2Processor.h"
...
namespace Ifrit::RHI::VulkanAdapter
{
    ...
    {
        IF_LOG_ASSERTION("Backend", size > 0, "Backend: Buffer size should be larger than 0");
        BufferCreateInfo ci{};
        ci.size        = size;
        ci.usage       = usage;
        ci.hostVisible = false;
