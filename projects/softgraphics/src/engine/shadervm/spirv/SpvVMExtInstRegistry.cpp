...
namespace Ifrit::GraphicsBackend::SoftGraphics::ShaderVM::Spirv::ExtInst::
    GlslStd450 {
#define DEF_INST(x)                                                            \
...
inline std::string glslstdFusedMultiplyAdd(
  ...
  std::string mangledName = functionName + "_" + mangledSpecType + "_" +
                            mangledSpecType + "_" + mangledSpecType;
...
#undef DEF_INST
  ...
  // Ifrit::GraphicsBackend::SoftGraphics::ShaderVM::Spirv::ExtInst::GlslStd450
