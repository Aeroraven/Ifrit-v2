...
IFRIT_APIDECL_COMPAT void IFRIT_APICALL iftrSetFrameBufferDepthAttachmentFP32(
    IFRIT_BASENS::FrameBuffer* pInstance, IFRIT_CORENS::ImageF32* pImage) IFRIT_EXPORT_COMPAT_NOTHROW
{
    pInstance->SetDepthAttachmentCompatible(pImage);
}

IFRIT_APIDECL_COMPAT IFRIT_BASENS::VaryingDescriptor* IFRIT_APICALL iftrCreateVaryingDescriptor()
    IFRIT_EXPORT_COMPAT_NOTHROW
{
