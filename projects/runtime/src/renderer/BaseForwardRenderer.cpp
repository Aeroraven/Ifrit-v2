...
namespace Ifrit::Runtime
{
        ...
        Scene* scene, PerFrameData& perframe, RenderTargets* renderTargets, const GPUCmdBuffer* cmd)
    {
        ...
        auto& rdgDepthBuffer =
            builder.ImportTexture("RDG.Imported.DepthBuffer", renderTargets->GetDepthStencilAttachment()->GetTexture());
        auto& rdgColorBuffer =
            builder.ImportTexture("RDG.Imported.ColorBuffer", renderTargets->GetColorAttachment(0)->GetRenderTarget());
        ...
        pass.SetExecutionFunction([this, &perframe, &rdgMainView, rtWidth, rtHeight](const FrameGraphPassContext& ctx) {
