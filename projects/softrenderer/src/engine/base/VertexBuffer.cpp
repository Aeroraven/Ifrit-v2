...
namespace Ifrit::Engine {
	...
	/* DLL Compatible */
	IFRIT_APIDECL void VertexBuffer::setLayoutCompatible(const TypeDescriptor* layouts, int num) {
	...
	IFRIT_APIDECL void VertexBuffer::setValueFloat4Compatible(const int index, const int attribute, const ifloat4 value) {
