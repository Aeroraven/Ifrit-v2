...
namespace Ifrit::Engine::SoftRenderer::Raytracer::Impl {
...
int getProfileCnt() {
  ...
  if constexpr (PROFILE_CNT) {
    int v = Ifrit::Engine::SoftRenderer::Raytracer::Impl::intersect;
    int vv = Ifrit::Engine::SoftRenderer::Raytracer::Impl::validIntersect;
    int bv = Ifrit::Engine::SoftRenderer::Raytracer::Impl::boxIntersect;
    int er = Ifrit::Engine::SoftRenderer::Raytracer::Impl::earlyReject;
    int cv = Ifrit::Engine::SoftRenderer::Raytracer::Impl::competeIntersect;
    ...
    Ifrit::Engine::SoftRenderer::Raytracer::Impl::intersect.store(0);
    Ifrit::Engine::SoftRenderer::Raytracer::Impl::competeIntersect.store(0);
    Ifrit::Engine::SoftRenderer::Raytracer::Impl::validIntersect.store(0);
    Ifrit::Engine::SoftRenderer::Raytracer::Impl::boxIntersect.store(0);
    Ifrit::Engine::SoftRenderer::Raytracer::Impl::earlyReject.store(0);
    return v;
  }
  return 0;
}