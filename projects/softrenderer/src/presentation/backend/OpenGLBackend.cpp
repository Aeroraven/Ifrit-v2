...
OpenGLBackend::OpenGLBackend() {
  std::fstream vertexShaderFile(IFRIT_SHADER_PATH "/opengl.backend.vert.glsl",
                                std::ios::in);
  std::fstream fragmentShaderFile(IFRIT_SHADER_PATH "/opengl.backend.frag.glsl",
                                  std::ios::in);
  std::string line;
...
void OpenGLBackend::setViewport(int32_t x, int32_t y, int32_t width,
                                int32_t height) {
