...
extern IFRIT_APIDECL_IMPORT void getRhiBackendBuilder_Vulkan(std::unique_ptr<Rhi::RhiBackendFactory> &ptr);
} // namespace Ifrit::GraphicsBackend::VulkanGraphics

namespace Ifrit::GraphicsBackend::Rhi {
IFRIT_APIDECL std::unique_ptr<RhiBackend> RhiSelector::createBackend(RhiBackendType type,
