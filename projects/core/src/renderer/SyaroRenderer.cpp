...
IF_CONSTEXPR auto kbBufUsage_Indirect =
    RHI_BUFFER_USAGE_INDIRECT_BUFFER_BIT | RHI_BUFFER_USAGE_TRANSFER_DST_BIT | RHI_BUFFER_USAGE_STORAGE_BUFFER_BIT;
IF_CONSTEXPR auto kbBufUsage_SSBO_CopyDest = RHI_BUFFER_USAGE_STORAGE_BUFFER_BIT | RHI_BUFFER_USAGE_TRANSFER_DST_BIT;
