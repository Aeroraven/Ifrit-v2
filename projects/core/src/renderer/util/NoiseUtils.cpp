    ...
    IFRIT_APIDECL RhiTextureRef loadBlueNoise(Graphics::Rhi::RhiBackend* rhi)
    {
        ...
        auto tex =
            rhi->CreateTexture2D("Noise_Tex2D", width, height, Graphics::Rhi::RhiImageFormat::RhiImgFmt_R8G8B8A8_UNORM,
                Graphics::Rhi::RhiImageUsage::RHI_IMAGE_USAGE_SAMPLED_BIT | Graphics::Rhi::RhiImageUsage::RHI_IMAGE_USAGE_TRANSFER_DST_BIT,
                false);
        auto buf = rhi->CreateBuffer("Noise_Buffer", width * height * 4,
            Graphics::Rhi::RhiBufferUsage::RhiBufferUsage_CopySrc, true, false);
        buf->MapMemory();
