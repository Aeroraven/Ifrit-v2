...
namespace Ifrit::Core
{
    ...
    Math::SIMD::SVector3f toVec3(const Vector3f& v)
    {
        return { v.x, v.y, v.z };
    }
        ...
        auto createPbrAtmoTex2D = [&](u32 width, u32 height) {
            ...
            auto tex =
                rhi->CreateTexture2D("PbrAtmo_Tex2D", width, height, RhiImageFormat::RhiImgFmt_R32G32B32A32_SFLOAT,
                    RhiImageUsage::RHI_IMAGE_USAGE_STORAGE_BIT | RhiImageUsage::RHI_IMAGE_USAGE_SAMPLED_BIT | RhiImageUsage::RHI_IMAGE_USAGE_TRANSFER_DST_BIT,
                    true);
            return tex;
        };
    ...
    IFRIT_APIDECL PbrAtmosphereRenderer::GPUShader*
                  PbrAtmosphereRenderer::CreateShaderFromFile(const String& shaderPath, const String& entry,
    ...
    IFRIT_APIDECL void PbrAtmosphereRenderer::SetupSingleScatteringPass()
    {
        ...
        auto shader            = CreateShaderFromFile("PAS.ComputeSingleScattering.comp.glsl", "main",
                       Graphics::Rhi::RhiShaderStage::Compute);
    ...
    IFRIT_APIDECL std::unique_ptr<PbrAtmosphereRenderer::GPUCommandSubmission>
                  PbrAtmosphereRenderer::RenderInternal(PerFrameData& perframe, const Vec<GPUCommandSubmission*>& cmdToWait)
    {
        ...
        auto runCmdOrder = [&](const RhiCommandList* cmd, u32 order) {
            ...
            cmd->AddResourceBarrier({ singleRayleighScatterBarrier, singleMieScatterBarrier, scatteringBarrier, irradianceBarrier,
