...
//     public:
//         GLTFMesh(
//             AssetMetadata* metadata, GLTFAsset* asset, u32 meshId, u32 primitiveId, u32 nodeId, const String&
//             cachePath) : m_asset(asset), m_meshId(meshId), m_primitiveId(primitiveId), m_nodeId(nodeId),
