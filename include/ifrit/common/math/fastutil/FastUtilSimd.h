...
namespace Ifrit::Math
{
    ...
    inline __m256 ApproxReciprocalNR256(__m256 x)
    {
    ...
    inline __m256 FlipFp32Sign256(__m256 x)
    {
    ...
    // With stride of 4.
    inline void Gather32Fp32Stride4_256(f32* data, __m256& r0, __m256& r1, __m256& r2, __m256& r3)
    {
