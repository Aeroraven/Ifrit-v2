...
// Address ops
template <typename T> inline T elementAt(CoreVec2<T> &a, int i) {
  return i == 0 ? a.x : a.y;
}
template <typename T> inline T elementAt(CoreVec3<T> &a, int i) {
...
// Length ops
template <typename T> inline T length(const CoreVec2<T> &a) {
  return sqrt(a.x * a.x + a.y * a.y);
}
template <typename T> inline T length(const CoreVec3<T> &a) {
...
// Dot ops
template <typename T> inline T dot(const CoreVec2<T> &a, const CoreVec2<T> &b) {
...
// Lerp ops
template <typename T>
inline CoreVec2<T> lerp(const CoreVec2<T> &a, const CoreVec2<T> &b,
                        const T &t) {
  return a * (1 - t) + b * t;
}
template <typename T>
inline CoreVec3<T> lerp(const CoreVec3<T> &a, const CoreVec3<T> &b,
                        const T &t) {
  return a * (1 - t) + b * t;
}
template <typename T>
inline CoreVec4<T> lerp(const CoreVec4<T> &a, const CoreVec4<T> &b,
                        const T &t) {
  return a * (1 - t) + b * t;
}
