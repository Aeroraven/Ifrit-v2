...
namespace Ifrit::GraphicsBackend::Rhi {
using RhiTextureRef = RhiCountRef<RhiTexture>;
using RhiSamplerRef = RhiCountRef<RhiSampler>;
using RhiBufferRef = RhiCountRef<RhiBuffer>;
