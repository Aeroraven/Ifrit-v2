...
namespace Ifrit::Graphics::SoftGraphics::ShaderVM::SpirvVec::LLVM
{
	class SpVcLLVMExpr
	{
	public:
	...
	public:
		...
		SpVcLLVMCompContainer(Tp... components)
	...
	public:
		...
		SpVcLLVMTypePointer(SpVcLLVMType* baseType)
			: mBaseType(baseType) {}
	...
	public:
		...
		SpVcLLVMTypeStruct(std::vector<SpVcLLVMType*> members)
			: mMembers(members) {}
		std::string emitIR() override
		{
			std::string ret = "{";
	...
	public:
		...
		SpVcLLVMTypeStructAliased(std::string name)
			: mName(name) {}
	...
	public:
		...
		SpVcLLVMLocalVariableName(std::string name)
			: mName(name) {}
		std::string emitIR() override { return "%" + mName; }
	};
	...
	public:
		...
		SpVcLLVMGlobalVariableName(std::string name)
			: mName(name) {}
		std::string emitIR() override { return "@" + mName; }
	};
	...
	public:
		...
		SpVcLLVMLabelName(std::string name)
			: mName(name) {}
		std::string emitIR() override { return mName + ":"; }
	...
	public:
		...
		SpVcLLVMConstantValueInt(int value)
			: mValue(value) {}
	...
	private:
		double floatToDoubleDeserialization(float x)
		{
			...
			u64	 exponentDouble = 0;
			u64	 fractionDouble = 0;
			if (isNan || isInf)
			{
			...
			else
			{
				...
				fractionDouble = static_cast<u64>(fractionFloat) << (52 - 23);
			}
			u64 signDouble = static_cast<u64>(signFloat) << 63;
			exponentDouble = exponentDouble << 52;
			u64 result = signDouble | exponentDouble | fractionDouble;
			return *(double*)(&result);
		}

	public:
		virtual ~SpVcLLVMConstantValueFloat32() = default;
		SpVcLLVMConstantValueFloat32(float value)
			: mValue(value) {}
		...
		std::string emitIR() override
		{
			...
			return std::format("0x{:X}", *(u64*)(&doubleVal));
		}
	};
	...
	public:
		...
		{
			return std::format("{} = load {}, {}* {}", std::get<0>(mComponents)->emitIRName(),
				std::get<0>(mComponents)->emitIRType(), std::get<1>(mComponents)->emitIRType(),
	...
	public:
		...
		std::string emitIR() override
		{
			return std::format("store {}, {}* {}", std::get<0>(mComponents)->emitIR(), std::get<1>(mComponents)->emitIRType(),
				std::get<1>(mComponents)->emitIRName());
		}
	};
	...
	public:
		...
		std::string emitIR() override
		{
			return std::format("{} = global {}  undef", std::get<0>(mComponents)->emitIRName(),
	...
	public:
		...
		SpVcLLVMIns_MathBinary(SpVcLLVMArgument* dest, SpVcLLVMArgument* src1, SpVcLLVMArgument* src2, std::string op)
			: SpVcLLVMCompContainer(dest, src1, src2), mOp(op) {}
		std::string emitIR() override
		{
			return std::format("{} = {} {}, {}", std::get<0>(mComponents)->emitIRName(), mOp,
				std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents)->emitIRName());
		}
	};
	...
	public:
		...
		SpVcLLVMIns_MathUnary(SpVcLLVMArgument* dest, SpVcLLVMArgument* src, std::string op)
	...
	public:
		...
		SpVcLLVMIns_Ret(SpVcLLVMArgument* src)
			: SpVcLLVMCompContainer(src) {}
		std::string emitIR() override { return std::format("ret {}", std::get<0>(mComponents)->emitIR()); }
	};
	...
	public:
		...
		SpVcLLVMIns_Br(SpVcLLVMLabelName* label)
			: SpVcLLVMCompContainer(label) {}
		std::string emitIR() override { return std::format("br label {}", std::get<0>(mComponents)->emitIRAsVar()); }
	};
	...
	public:
		...
		SpVcLLVMIns_BrCond(SpVcLLVMArgument* cond, SpVcLLVMLabelName* trueLabel, SpVcLLVMLabelName* falseLabel)
		...
		std::string emitIR() override
		{
			return std::format("br {}, label {}, label {}", std::get<0>(mComponents)->emitIR(),
				std::get<1>(mComponents)->emitIRAsVar(), std::get<2>(mComponents)->emitIRAsVar());
		}
	};
	...
	public:
		SpVcLLVMIns_BeginFunction(std::string name, SpVcLLVMType* returnType, std::vector<SpVcLLVMArgument*> args)
	...
	{
	public:
		SpVcLLVMIns_Select(SpVcLLVMArgument* dest, SpVcLLVMArgument* cond, SpVcLLVMArgument* trueVal,
			SpVcLLVMArgument* falseVal)
			: SpVcLLVMCompContainer(dest, cond, trueVal, falseVal) {}
		std::string emitIR() override
		{
			return std::format("{} = select {}, {}, {}", std::get<0>(mComponents)->emitIRName(),
	...
	{
	public:
		SpVcLLVMIns_InsertElement(SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, SpVcLLVMArgument* val, SpVcLLVMArgument* idx)
			: SpVcLLVMCompContainer(dest, vec, val, idx) {}
		std::string emitIR() override
		{
			return std::format("{} = insertelement {}, {}, {}", std::get<0>(mComponents)->emitIRName(),
				std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents)->emitIR(),
				std::get<3>(mComponents)->emitIR());
		}
	};
	...
	{
	public:
		SpVcLLVMIns_InsertElementWithConstantIndex(SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, SpVcLLVMArgument* val,
			int idx)
			: SpVcLLVMCompContainer(dest, vec, val, idx)
		{
			if (vec == nullptr)
		...
		std::string emitIR() override
		{
			return std::format("{} = insertelement {}, {}, i32 {}", std::get<0>(mComponents)->emitIRName(),
				std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents)->emitIR(),
	...
	{
	public:
		SpVcLLVMIns_InsertElementWithConstantIndexUndefInit(SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, int idx)
			: SpVcLLVMCompContainer(dest, vec, idx) {}
		std::string emitIR() override
		{
			return std::format("{} = insertelement {} undef, {} , i32 {}", std::get<0>(mComponents)->emitIRName(),
				std::get<0>(mComponents)->emitIRType(), std::get<1>(mComponents)->emitIR(),
	...
	{
	public:
		SpVcLLVMIns_ExtractElementWithConstantIndex(SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, int idx)
			: SpVcLLVMCompContainer(dest, vec, idx) {}
		std::string emitIR() override
		{
			return std::format("{} = extractelement {}, i32 {}", std::get<0>(mComponents)->emitIRName(),
	...
	public:
		...
		SpVcLLVMIns_FunctionCallExtInst(SpVcLLVMArgument* retVal, std::string funcName,
	...
	public:
		SpVcLLVMIns_FunctionFragmentEntry(std::string name)
			: mName(name) {}
		std::string emitIR() override { return std::format("define void @{}", mName) + "() #0 {"; }
	};
	...
	{
	public:
		SpVcLLVMIns_ExtractValueWithConstantIndex(SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, int idx)
			: SpVcLLVMCompContainer(dest, vec, idx) {}
		std::string emitIR() override
		{
			return std::format("{} = extractvalue {}, {}", std::get<0>(mComponents)->emitIRName(),
				std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents));
		}
	};
  ...
  // Ifrit::Graphics::SoftGraphics::ShaderVM::SpirvVec::LLVM