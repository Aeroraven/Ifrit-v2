...
namespace Ifrit::Graphics::SoftGraphics::ShaderVM::SpirvVec::LLVM
{
    ...
    public:
        ...
        {
            return std::format(
                "{} = alloca {}", std::get<0>(mComponents)->emitIRName(), std::get<1>(mComponents)->emitIR());
        }
    };
    ...
    public:
        ...
        std::string emitIR() override
        {
            return std::format("store {}, {}* {}", std::get<0>(mComponents)->emitIR(),
                std::get<1>(mComponents)->emitIRType(), std::get<1>(mComponents)->emitIRName());
        }
    };
    ...
    public:
        ...
        {
            return std::format(
                "{} = {} {}", std::get<0>(mComponents)->emitIRName(), mOp, std::get<1>(mComponents)->emitIR());
        }
    };
    ...
    public:
        ...
        std::string emitIR() override
        {
            ...
            return std::format(
                "{} = add {}, 0", std::get<0>(mComponents)->emitIR(), std::get<1>(mComponents)->emitIR());
        }
    };
    ...
    public:
        SpVcLLVMIns_Select(
            SpVcLLVMArgument* dest, SpVcLLVMArgument* cond, SpVcLLVMArgument* trueVal, SpVcLLVMArgument* falseVal)
    ...
    {
    public:
        SpVcLLVMIns_InsertElement(
            SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, SpVcLLVMArgument* val, SpVcLLVMArgument* idx)
    ...
    {
    public:
        SpVcLLVMIns_InsertElementWithConstantIndex(
            SpVcLLVMArgument* dest, SpVcLLVMArgument* vec, SpVcLLVMArgument* val, int idx)
            : SpVcLLVMCompContainer(dest, vec, val, idx)
        {
            if (vec == nullptr)
            {
        ...
        std::string emitIR() override
        {
            return std::format("{} = insertelement {}, {}, i32 {}", std::get<0>(mComponents)->emitIRName(),
                std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents)->emitIR(), std::get<3>(mComponents));
        }
    };
    ...
    public:
        ...
        std::string emitIR() override
        {
            return std::format("{} = insertelement {} undef, {} , i32 {}", std::get<0>(mComponents)->emitIRName(),
                std::get<0>(mComponents)->emitIRType(), std::get<1>(mComponents)->emitIR(), std::get<2>(mComponents));
        }
    };
    ...
    public:
        ...
        SpVcLLVMIns_FunctionCallExtInst(
            SpVcLLVMArgument* retVal, std::string funcName, const std::vector<SpVcLLVMArgument*> args)
