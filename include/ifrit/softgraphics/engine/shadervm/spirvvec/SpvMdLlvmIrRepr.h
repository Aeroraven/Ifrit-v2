...
class SpVcTypedVariable : public virtual SpVcLLVMExpr,
...
class SpVcLLVMIns_TypeAlias : public SpVcLLVMInstruction,
                              public SpVcLLVMCompContainer<SpVcLLVMLocalVariableName *, SpVcLLVMType *> {
public:
...
class SpVcLLVMIns_Alloca : public SpVcLLVMInstruction,
...
class SpVcLLVMIns_Load : public SpVcLLVMInstruction,
...
class SpVcLLVMIns_LoadForcedPtr : public SpVcLLVMInstruction,
                                  public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *> {
public:
...
class SpVcLLVMIns_Store : public SpVcLLVMInstruction,
                          public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *> {
public:
...
class SpVcLLVMIns_StoreForcedPtr : public SpVcLLVMInstruction,
                                   public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *> {
public:
...
class SpVcLLVMIns_MathBinary
    : public SpVcLLVMInstruction,
      public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *, SpVcLLVMArgument *> {
  std::string mOp;
...
class SpVcLLVMIns_MathUnary : public SpVcLLVMInstruction,
                              public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *> {
  std::string mOp;
...
class SpVcLLVMIns_BrCond : public SpVcLLVMInstruction,
                           public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMLabelName *, SpVcLLVMLabelName *> {
public:
...
class SpVcLLVMIns_ImmediateAssign : public SpVcLLVMInstruction,
                                    public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *> {
public:
...
class SpVcLLVMIns_Select
    : public SpVcLLVMInstruction,
      public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *, SpVcLLVMArgument *, SpVcLLVMArgument *> {
public:
...
class SpVcLLVMIns_InsertElementWithConstantIndex
    : public SpVcLLVMInstruction,
      public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *, SpVcLLVMArgument *, int> {
public:
...
class SpVcLLVMIns_InsertElementWithConstantIndexUndefInit
    : public SpVcLLVMInstruction,
      public SpVcLLVMCompContainer<SpVcLLVMArgument *, SpVcLLVMArgument *, int> {
public:
