...
public:
  IFRIT_HOST void pushStack(const RayInternal &ray, const RayHit &rayHit,
                            void *pPayload);
...
public:
  IFRIT_DUAL virtual void execute(const iint3 &inputInvocation,
                                  const iint3 &dimension, void *context) = 0;
...
class IFRIT_APIDECL MissShader : public ShaderBase,
                                 public RaytracerShaderExecutionStack {
public:
...
public:
  IFRIT_DUAL virtual void execute(const RayHit &hitAttribute,
                                  const RayInternal &ray, void *context) = 0;
...
class IFRIT_APIDECL CallableShader : public ShaderBase,
                                     public RaytracerShaderExecutionStack {
public:
  IFRIT_DUAL virtual void execute(void *outPayload, void *inPayload,
                                  void *context) = 0;
