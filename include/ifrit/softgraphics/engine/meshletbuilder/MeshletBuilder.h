...
namespace Ifrit::Graphics::SoftGraphics::MeshletBuilder
{
    ...
    public:
        ...
        void buildMeshlet(int posAttrId, std::vector<Owner<Meshlet>>& outData);
        void mergeMeshlet(const std::vector<Owner<Meshlet>>& meshlets, Meshlet& outData,
            std::vector<int>& outVertexOffset, std::vector<int>& outIndexOffset, bool autoIncre);
    };
} // namespace Ifrit::Graphics::SoftGraphics::MeshletBuilder