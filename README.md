...
> ^. You can still use partial of the `Ifrit.Runtime` features without some extensions. That means you can use the core features to create a new project. However, three subprojects will not work properly without these extensions. Your app might crash or fail to run.
